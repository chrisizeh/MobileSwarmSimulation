...
sim = Simulation(robots, area; open_area=true, time_step=0.1)
...
robots = [robot1, robot2]
sim2 = Simulation(robots, area; open_area=false, time_step=0.05, num_grid=5)
...
sim = Simulation(robots, area; open_area=false, time_step=0.1)
